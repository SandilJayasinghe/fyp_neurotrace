  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-[#0f172a] animate-fade-in relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <p className="text-sm text-slate-400">Join the Tremora analysis platform</p>
      </div>
          ...
          {success ? (
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <input name="name" required onChange={handleChange} value={formData.name} className="block w-full rounded-xl bg-slate-900/50 py-3 pl-11 text-white ring-1 ring-slate-700/50 focus:ring-2 focus:ring-sky-500 transition-all text-sm" placeholder="John Doe" />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input name="email" type="email" required onChange={handleChange} value={formData.email} className="block w-full rounded-xl bg-slate-900/50 py-3 pl-11 text-white ring-1 ring-slate-700/50 focus:ring-2 focus:ring-sky-500 transition-all text-sm" placeholder="john@example.com" />
              ...
              <div>
                ...
                <div className="relative">
                  <input name="password" type="password" required onChange={handleChange} value={formData.password} className="block w-full rounded-xl bg-slate-900/50 py-3 pl-11 text-white ring-1 ring-slate-700/50 focus:ring-2 focus:ring-sky-500 transition-all text-sm" placeholder="••••••••" />
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input name="dob" type="date" onChange={handleChange} value={formData.dob} className="block w-full rounded-xl bg-slate-900/50 py-3 px-3 text-white ring-1 ring-slate-700/50 focus:ring-2 focus:ring-sky-500 transition-all text-sm cursor-pointer" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-slate-400 mb-1 ml-1 uppercase tracking-wider">Age</label>
                  <input name="age" type="number" onChange={handleChange} value={formData.age} className="block w-full rounded-xl bg-slate-900/50 py-3 px-4 text-white ring-1 ring-slate-700/50 focus:ring-2 focus:ring-sky-500 transition-all text-sm" placeholder="25" />
                </div>
                <div>
                  <label className="block text-xs font-medium text-slate-400 mb-1 ml-1 uppercase tracking-wider">Gender</label>
                  <select name="gender" onChange={handleChange} value={formData.gender} className="block w-full rounded-xl bg-slate-900/50 py-3 px-3 text-white ring-1 ring-slate-700/50 focus:ring-2 focus:ring-sky-500 transition-all text-sm cursor-pointer border-r-8 border-transparent">
